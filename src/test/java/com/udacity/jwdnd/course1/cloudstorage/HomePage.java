...
public class HomePage {
    ...
    public Note getFirstNote() {
        Note note = new Note();
        note.setNoteTitle(wait.until(ExpectedConditions.elementToBeClickable(tableNoteTitle)).getText());
        note.setNoteDescription(tableNoteDescription.getText());
    ...
    public Credential getFirstCredential() {
        ...
        credential.setUrl(wait.until(ExpectedConditions.elementToBeClickable(tblCredentialUrl)).getText());
        credential.setUserName(tblCredentialUsername.getText());
        credential.setPassword(tblCredentialPassword.getText());
